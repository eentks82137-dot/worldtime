...
<body class="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(251,191,36,0.28),_transparent_28%),linear-gradient(135deg,_#fffaf0_0%,_#f8fafc_45%,_#e2e8f0_100%)] text-slate-900">
    <main class="mx-auto flex min-h-screen w-full max-w-6xl items-center px-6 py-10">
        <section class="grid w-full gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
            <div class="space-y-6">
                <p class="text-sm font-semibold uppercase tracking-[0.45em] text-amber-700">World Time</p>
                <div class="space-y-4">
                    <h1 class="max-w-2xl text-3xl font-black tracking-tight text-slate-950 sm:text-3xl">원하는 도시의 현재 시간을 확인하세요</h1>
                    <p class="max-w-xl text-base leading-7 text-slate-600 sm:text-lg">언어와 시간대를 선택하면 현재 시각을 바로 확인할 수 있습니다.</p>
                </div>
